package com.spotblock.app.diagnostics

import android.content.Context
import com.spotblock.app.SettingsRepository
import java.io.File
 ...
 * outcome), every skip attempt and why it did or didn't happen, every exception caught
 * elsewhere in the app. The Activity log answers "what happened"; this answers "why",
 * which is what's actually needed to tune a keyword list or report a bug.
 *
...
class DiagnosticLog(context: Context, private val settingsRepository: SettingsRepository) {
    ...
    /** Trims to roughly the last MAX_FILE_SIZE_BYTES worth of characters, then discards
